...
class PhoneOtpVerificationStep extends StatelessWidget {
  PhoneOtpVerificationStep({super.key});
                    ...
                    ? () async {
                        ...
                        final UserModel newUser = UserModel(
                          phone: localUser.phone != null &&
                              ...
                              ? localUser.phone!
                              : _userController.phone.trim(),
                        );
                        await _userController.createAndSendOtp(newUser, true);
                        Get.back();
                        if (_userController.err.isNotEmpty) {
                          Constants.snackBar(
                              bgColor: AppColors.red,
